...
public class Luru extends JFrame implements ActionListener, Public_ {
...
//		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
	...
	public void init()
	{
		...
		JLabel label2 = new JLabel("   玩 具 类 型  : ");
	...
	public void actionPerformed(ActionEvent e) {	//按钮监听
		...
		String toytype = field2.getText() ;
		String toyower = field3.getText() ;
		String price = field4.getText();
		String color = field5.getText();
		String hire = field6.getText();	//把信息录入框内，然后后面通过sql语句录入

		
		if(source == buttonOfQueDing)//是否安了按钮
		{
			if(number.equals("")||toytype.equals("")||toyower.equals("")||price.equals("")||color.equals("")||hire.equals(""))
			{
			...
			else
			{
				...
				try {
					...
					String str = "insert into toy_information (number,toytype,toyower,price,color,hire)values('"+numberint+"','"+toytype+"','"+toyower+"','"+price+"','"+color+"','"+hire+"');";
					stmt.executeUpdate(str);
					JOptionPane.showMessageDialog(null, "录入成功！");
					this.closeDB();
					this.dispose();
					new Guanliyuan(true);	//这里展示表格
